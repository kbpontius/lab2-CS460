...
class Main(object):
    ...
    def run(self):
        ...
        # n4.add_forwarding_entry(address=n3.get_address('n2'),link=n4.links[0])  # n4 -> n2 -> n3
        ...
        ### Competing 4-node configuration
        ...
        with open(self.filename,'r') as f:
            while True:
                ...
                if not data:
                    break
                # Two Nodes && Competing 4-node configuration
